...
export function addMissingStateItems() {
  ...
  if (!checkValidObject(store.getStateItem('mapLayerDisplayStatus'))) {
    store.setStoreItem('mapLayerDisplayStatus', {
      ...
      AS_ErosionTMS: false,
      AS_SLRTMS: false,
      AS_WaveDrivenFloodingTMS: false,
      ...
      GL_AssetsTMS: false,
      GL_ThreatsTMS: false,
      GL_CombinedWildlifeTMS: false,
      GL_AquaticTMS: false,
      GL_TerrestrialTMS: false,
      GL_SocVulnTMS: false,
      GL_PopDensityTMS: false,
      GL_CriticalFacilitiesTMS: false,
      GL_CommunityInfrastructurTMS: false,
      GL_ErosionTMS: false,
      GL_FloodProneAreasTMS: false,
      GL_SlopeTMS: false,
      GL_DraingeTMS: false,
      GL_MaxWaterLevelTMS: false,
      GL_AIANNHATMS: false,
      GL_CededTerritoryTMS: false,
      GL_USA_Department_of_Defense_LandsTMS: false,
      GL_FetchTMS: false,
      GL_LakeFluctuationZoneTMS: false
    });
  }
